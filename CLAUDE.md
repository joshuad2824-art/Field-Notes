...
rotted: **507 assertions in six files**, all green. `tests/editor.mjs` has 275 covering the editor,
...
`tests/spreadsheet.mjs` has 59, and it asks one question over and over: **does the
