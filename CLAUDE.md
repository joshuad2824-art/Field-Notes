...
rotted: 227 assertions in two files. `tests/editor.mjs` has 168 covering the editor,
...
`tests/sync.mjs` has 59, in two halves — the reconciler's truth table and the pairing
